...
const STR := {
	"zh": {
		...
		"board_grip": "··· 拖此調整高度 ···",
		"board_empty": "避難所空無一人…",
		"board_company": "🏚 避難所 · %d 名倖存者值勤",
		"board_totals": "⚒ 產出 %s   📖 閱讀 %s",
		"board_turns": "🔁 共 %d 回合",
		"board_supplies": "📦 物資 %s（今日 +%s）",
		"hud_econ": "💵 經費 %s　📦 物資 %s",
		"c_upgrade": "強化",
		"c_upgrade_tip": "強化避難所：餵養 CLAUDE CODE、買物資、升級",
		"up_title": "🛠 強化避難所",
		"up_energy": "⚡ 能量 %d%%",
		"up_feed": "餵養 +%d能量（-%d📦）",
		"up_buy": "💵→📦 買物資（-%d💵 +%d📦）",
	...
	"en": {
		...
		"board_empty": "The shelter is empty…",
		"board_company": "🏚 Shelter · %d survivors on duty",
		"board_totals": "⚒ Out %s   📖 Read %s",
		"board_turns": "🔁 %d turns",
		"board_supplies": "📦 Supplies %s (today +%s)",
		"hud_econ": "💵 Funds %s　📦 Supplies %s",
		"c_upgrade": "Buff",
		"c_upgrade_tip": "Reinforce: feed CLAUDE CODE, buy supplies, upgrade",
		"up_title": "🛠 Reinforce shelter",
		"up_energy": "⚡ Energy %d%%",
		"up_feed": "Feed +%d energy (-%d📦)",
		"up_buy": "💵→📦 Buy supplies (-%d💵 +%d📦)",
		"up_supply": "📦 Supply rate",
		"up_defense": "🛡 Door defense",
		"up_power": "⚔ Power (spd/range)",
		"up_row": "%s　Lv%d",
		"up_btn": "↑ -%s📦",
